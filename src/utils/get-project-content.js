 ...
 * @return {import('../../types').ICollection[]}
 */
 ...
 * Get a list of fragments from a given collection directory
 * @param {string} collectionDirectory
 * @return {import('../../types').IFragmentComposition[]}
 */
 ...
 * @param {string} basePath Base path
 * @return {import('../../types').IPageTemplate[]}
 */
 ...
 * @param {string} basePath Base path
 * @return {import('../../types').IProject} Project
 */
