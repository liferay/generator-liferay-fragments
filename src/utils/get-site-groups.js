...
/**
 * @param {import('../../types').ISiteGroup} group Site group
 ...
 * @param {import('../../types').ISiteGroup[]} siteGroups Site groups
 * @param {import('../../types').ISiteGroup[]} stagingGroups Staging groups
 * @return {import('../../types').ISiteGroup[]} Merged groups
 */
 ...
 * @return {Promise<import('../../types').ISiteGroup[]>} Site groups
 */
